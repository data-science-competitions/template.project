...
try(remotes::install_cran(c("desc", "devtools", "webshot")))
...
<!-- badges: start -->
`r badge_custom("Project Website", "Click-Here", "9cf", desc_obj$get_urls()[[1]])`
...
See the [project website](`r desc_obj$get_urls()[[1]]`) for more information. 
