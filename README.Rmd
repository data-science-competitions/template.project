...
DESCRIPTION <- desc::description$new(usethis::proj_path("DESCRIPTION"))
```
...
badges$CICD <- list(
  ...
  src = glue("https://github.com/{slug}/workflows/test-suite/badge.svg?branch={branch}", slug = slug, branch = branch)
)
badges$covr <- list(
